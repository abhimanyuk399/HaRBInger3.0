  ...
  'inline-flex items-center justify-center whitespace-nowrap rounded-full text-sm font-semibold transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-400 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        ...
        secondary: 'bg-white text-slate-700 border border-slate-200 hover:bg-slate-50 dark:bg-slate-900/60 dark:border-slate-700 dark:text-slate-100 dark:hover:bg-slate-900/80',
        ghost: 'text-slate-700 hover:bg-slate-100 dark:text-slate-100 dark:hover:bg-white/10',
      },
      size: {
        md: 'h-11 px-6',
        lg: 'h-12 px-8',
