...
export default function WalletHomePage() {
  ...
  useEffect(() => {
    ...
    // Ensure dashboard counts are loaded without requiring a manual browser refresh, and refresh when wallet identity changes.
    void Promise.allSettled([
      refreshWalletConsents(activeWalletUsername ?? undefined),
      refreshDelegations(activeWalletUsername ?? undefined),
